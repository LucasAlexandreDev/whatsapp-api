...
// Endpoint - help (docs) | responsável por retornar todo os Enpoints necessário para a utilização da API
app.get('/v1/whatsapp/help', function(request, response){

    let docsAPI = 
    {
        "api-description" : "API para manipular dados de mensagens (usuário, contato, conversas e palavra-chave) do whatsapp ",
        "date"            : "13/04/02",
        "development"     : "Lucas Alexandre da Silva",
        "version"         : 1.0,
        "endpoints"       : [
            {
                "router1"    : "/v1/whatsapp/lista/dados/usuarios", 
                "description": "Retorna a lista de dados de todos os usuários"
            },

            {
                "router2"    : "/v1/whatsapp/dados/perfil/usuario/:numeroUsuario",
                "description": "Retorna todos os dados de perfil do usuário",
                "parms"      : "numero de telefone do usuário"
            },

            {
                "router3"     : "/v1/whatsapp/dados/contatos/usuario/:numeroUsuario",
                "description" : "Retorna os dados do usuário e todos os seus contatos",
                "parms"      : "numero de telefone do usuário"
            },
            
            {
                "router4"     : "/v1/whatsapp/conversas/trocadas/usuario/contatos/:numeroUsuario",
                "description" : "Retorna os dados do usuário e todas as conversas trocadas entre seus contatos",
                "parms"       : "numero de telefone do usuário"
            },

            {
                "router5"     : "/v1/whatsapp/conversa/trocada/usuario/:numeroUsuario/contato",
